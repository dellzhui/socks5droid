...
extern "C" {
JNIEXPORT jint JNICALL Java_com_github_appproxy_JniHelper_sigkill(JNIEnv *env, jobject thiz, jint pid) {
...
JNIEXPORT jint JNICALL Java_com_github_appproxy_JniHelper_sigterm(JNIEnv *env, jobject thiz, jobject process) {
...
JNIEXPORT jobject JNICALL
        Java_com_github_appproxy_JniHelper_getExitValue(JNIEnv *env, jobject thiz, jobject process) {
    if (!env->IsInstanceOf(process, ProcessImpl)) {
        THROW(env, "java/lang/ClassCastException",
                   "Unsupported process object. Only java.lang.ProcessManager$ProcessImpl is accepted.");
        return NULL;
...
JNIEXPORT jobject JNICALL
        Java_com_github_appproxy_JniHelper_getExitValueMutex(JNIEnv *env, jobject thiz, jobject process) {
    if (!env->IsInstanceOf(process, ProcessImpl)) {
        THROW(env, "java/lang/ClassCastException",
                   "Unsupported process object. Only java.lang.ProcessManager$ProcessImpl is accepted.");
        return NULL;
...
JNIEXPORT void JNICALL Java_com_github_appproxy_JniHelper_close(JNIEnv *env, jobject thiz, jint fd) {
    close(fd);
}

JNIEXPORT jint JNICALL
        Java_com_github_appproxy_JniHelper_sendFd(JNIEnv *env, jobject thiz, jint tun_fd, jstring path) {
    int fd;
...
Java_com_github_appproxy_JniHelper_parseNumericAddress(JNIEnv *env, jobject thiz, jstring str) {

...
object PluginContract {
     ...
     *
     * Constant Value: "com.github.appproxy.plugin.ACTION_NATIVE_PLUGIN"
     */
    const val ACTION_NATIVE_PLUGIN = "com.github.appproxy.plugin.ACTION_NATIVE_PLUGIN"

    /**
     * Activity Action: Used for ConfigurationActivity.
     *
     * Constant Value: "com.github.appproxy.plugin.ACTION_CONFIGURE"
     */
    const val ACTION_CONFIGURE = "com.github.appproxy.plugin.ACTION_CONFIGURE"
    /**
     * Activity Action: Used for HelpActivity or HelpCallback.
     *
     * Constant Value: "com.github.appproxy.plugin.ACTION_HELP"
     */
    const val ACTION_HELP = "com.github.appproxy.plugin.ACTION_HELP"

    /**
     * The lookup key for a string that provides the plugin entry binary.
     *
     * Example: "/data/data/com.github.appproxy.plugin.obfs_local/lib/libobfs-local.so"
     *
     * Constant Value: "com.github.appproxy.plugin.EXTRA_ENTRY"
     */
    const val EXTRA_ENTRY = "com.github.appproxy.plugin.EXTRA_ENTRY"
    /**
     * The lookup key for a string that provides the options as a string.
     *
     * Example: "obfs=http;obfs-host=www.baidu.com"
     *
     * Constant Value: "com.github.appproxy.plugin.EXTRA_OPTIONS"
     */
    const val EXTRA_OPTIONS = "com.github.appproxy.plugin.EXTRA_OPTIONS"
    /**
     ...
     *
     * Constant Value: "com.github.appproxy.plugin.EXTRA_HELP_MESSAGE"
    </host_name> */
    const val EXTRA_HELP_MESSAGE = "com.github.appproxy.plugin.EXTRA_HELP_MESSAGE"

    /**
     * The metadata key to retrieve plugin id. Required for plugins.
     *
     * Constant Value: "com.github.appproxy.plugin.id"
     */
    const val METADATA_KEY_ID = "com.github.appproxy.plugin.id"
    /**
     * The metadata key to retrieve default configuration. Default value is empty.
     *
     * Constant Value: "com.github.appproxy.plugin.default_config"
     */
    const val METADATA_KEY_DEFAULT_CONFIG = "com.github.appproxy.plugin.default_config"
     ...
     */
    const val AUTHORITY = "com.github.appproxy"
}
